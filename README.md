...
# Audiobook Maker
This version of Jarod's Audiobook Maker adds a replacement word list feature.  This feature allows you to create a list of words, that replace existing words, that the TTS pronounces incorrectly.  The easiest way to use it, is install Jarods version, download audio_book_app2.py, and start_package2.bat.  Then just run start_package2.bat.  Add words to list, save the list, and start making audiobooks.
