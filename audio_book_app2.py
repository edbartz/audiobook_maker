...
#from tortoise_api.tortoise_api import Tortoise_API
#from tortoise_api.tortoise_api import Newload_sentences,load_sentences, load_config, call_api
#******************************************************************************************************************************************************************
...
class AudiobookMaker(QMainWindow):
    ...
    def init_ui(self):
        ...
        #left_layout.addWidget(self.LoadWordListButton)
        ...
        left_layout.addLayout(self.LoadWordNameLayout)
        ...
        left_layout.addLayout(self.SaveEtcLayout)
        ...
        left_layout.addLayout(self.AddWordNameLayout)
        
        # Word widget
        self.WordWidget = QTableWidget(self)
        self.WordWidget.setColumnCount(2)
        self.WordWidget.setHorizontalHeaderLabels(['Word List','Replacement Word'])
        self.WordWidget.horizontalHeader().resizeSection(0, 200)
        self.WordWidget.horizontalHeader().resizeSection(1, 200)
        self.WordWidget.horizontalHeader().setSectionResizeMode(1, QHeaderView.Stretch)
        left_layout.addWidget(self.WordWidget)
...
#******************************************************************************************************************************************************************
    ...
    def LoadWordList(self):
        ...
        try:
            ...
            for idx_str, item in wordlist.items():
                ...
                self.rplwords.append([word_item.text(), repl_item.text()])
    ...
    def DelWordInList(self):
        #Remove selected word from wordlist
    ...
    def SaveList(self):
        ...
        while (idx<numRows):
            ...
            self.rplwords.append([self.WordWidget.item(idx, 0).text(), self.WordWidget.item(idx, 1).text()])
            idx=idx+1
    ...
    def TestRepl(self):
        ...
        audio_path = self.generate_audio(wordstr)
        ...
        shutil.copy(audio_path, testpath)
        self.media_player.setMedia(QMediaContent(QUrl.fromLocalFile(testpath)))
    ...
    def Paragraph2Sentence(self,paragraph) -> list:
        ...
        # Mark Sentence enders, so the paragraph can be split into sentences
        # Decided to end only with periods!
    ...
    def NewLoadTheTextFile(file_path) -> list:
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for paragraph in paragraphs:
                ...
                for item in rplwords:
                    paragraph = paragraph.replace(item[0],item[1])
                    
                filtered_list = self.Paragraph2Sentence(paragraph)
                sentences.extend(filtered_list)
        return sentences
        
        import re
    '''
    # Can't use this.  I guess is really is still a WIP
    def Paragraph2Sentences1(self,paragraph):
        #This is modified from Jarods WIP filter_Paragraph routine
        import nltk
    ...
    '''
    def Newload_sentences(self,file_path) -> list:
        '''
        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            filtered_sentences = []
            for paragraph in paragraphs:
            # Substitutions for mispronounced words.
...
#******************************************************************************************************************************************************************
    ...
    def start_generation(self):
        ...
        # Create directory based on the book name
            ...
            #******************************************************************************************************************************************************************
            sentence_list = self.Newload_sentences(self.filepath)
            #******************************************************************************************************************************************************************
    ...
    def update_audiobook(self):
        ...
        #******************************************************************************************************************************************************************
        sentence_list = self.Newload_sentences(filepath)
        #******************************************************************************************************************************************************************
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    def generate_audio(self, sentence):
        ...
        #audio_path = Tortoise_API.call_api(sentence, **parameters)
        #audio_path = Tortoise_API.call_api(self,sentence)
